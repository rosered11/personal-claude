...
_Last updated: 2026-06-10 — added P016/D021/S021 from datamart/dashboard-activity-log.md (RabbitMQ activity log ingestion channel for DataMartQueryService — IHostedService Hexagonal adapter + RabbitMQ.Client + service/repository ports; new precedent for RabbitMQ consumer integration in .NET 8)_
