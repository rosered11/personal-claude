...
public class ScheduleReturnPickupHandler(
    IReturnRepository returnRepository,
    IOutboxPublisher outboxPublisher) : IRequestHandler<ScheduleReturnPickupCommand, Result>
{
    public async Task<Result> Handle(ScheduleReturnPickupCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ret.SchedulePickup(request.PickupScheduledAt, request.UpdatedBy);
