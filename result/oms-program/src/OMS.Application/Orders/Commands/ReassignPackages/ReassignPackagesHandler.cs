...
public class ReassignPackagesHandler(
    IOrderRepository orderRepository,
    IOutboxPublisher outboxPublisher) : IRequestHandler<ReassignPackagesCommand, Result>
{
    public async Task<Result> Handle(ReassignPackagesCommand request, CancellationToken cancellationToken)
    {
